...
import signInBanner from "@/assets/images/sign-in/signin-banner.png";

export function SignIn() {
  const { formik, loading, error, getHelp, getStatus } = useSignInForm();
  ...
  return (
    <div className="sign-in-section container">
      ...
      <section className="hidden">
        <img src={signInBanner} alt="Banner sign in" />
      </section>
    </div>
  );
}
